...
/** Données utilisateur d'une exigence de référentiel complémentaire. */
interface EbiosCompEntry {
    conformite: EbNum;
    ecart: string;
    mesures_prevues: string;
    /** Accès générique par nom de champ (updateRefField / _refOnToggle). */
    [k: string]: unknown;
}

/** Exigence d'un référentiel complémentaire (catalogue chargé en lazy). */
interface EbiosRefMeasure {
    ref: string;
    theme: string;
    theme_en?: string;
    mesure: string;
...
/** Référentiel complémentaire (chips + tableau de l'onglet Socle). */
interface EbiosRefMeta {
    label: string;
    description?: string;
    description_en?: string;
    color: string;
    /** Renseigné après chargement lazy du fichier EBIOS_RM_ref_<id>.js. */
    measures: EbiosRefMeasure[];
    [k: string]: unknown;
}
...
interface EbiosData {
    ...
    socle_complementaires: Record<string, Record<string, EbiosCompEntry>>;
...
interface Window {
    ...
    EBIOS_REF?: Record<string, EbiosRefMeta>;
    ...
    catalogOpen?: (id: string) => void;
    catalogDuplicate?: (id: string) => void;
    catalogRename?: (id: string) => void;
    catalogDelete?: (id: string) => void;
    catalogExport?: (id: string) => void;
